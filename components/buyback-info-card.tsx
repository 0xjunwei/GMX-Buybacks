...
import type { BuybackTokenInfo } from "@/lib/api"

interface BuybackInfoCardProps {
  tokens: BuybackTokenInfo[]
}

export function BuybackInfoCard({ tokens }: BuybackInfoCardProps) {
    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg">Buyback Tokens</CardTitle>
